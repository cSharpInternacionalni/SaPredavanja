...
namespace Avantura
{
    class Soba
    {
        ...
        private Soba[] povezaneSobe = new Soba[4];
        ...
        public static void poveziSobe(Soba a, Soba b, int pravac)
        {
            ...
            if (a.povezaneSobe[pravac] != null)
                a.povezaneSobe[pravac].povezaneSobe[(pravac + 2) % 4] = null;

            a.povezaneSobe[pravac] = b;
